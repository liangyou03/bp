...
# ============== 本地模块导入 ==============
from backbones_clip import AgeModel  # 结构不变，仍可复用
...
DEFAULT_PRETRAIN  = "/home/youliang/youliang_data2/bp/bp_exp_v1/runs/clip_pretrain_500hz/clip_best.pth"
...
def main():
    ...
    model.load_from_clip_pretrain(args.pretrain, device=device)
